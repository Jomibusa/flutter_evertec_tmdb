...
import 'package:flutter_evertec_tmdb/presentation/home/delegates/search_movie_delegate.dart';
import 'package:flutter_evertec_tmdb/presentation/home/providers/search_movies_provider.dart';
                ...
                onPressed: () {
                  ...
                  showSearch<Movie?>(
                    ...
                    (movie) {
                      ...
                      ref
                          .read(movieLocalSaveProvider.notifier)
                          .saveMovie(movie);
